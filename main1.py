...
#train the chosen model on every combination of hyperparameters and create a list of model accuracies by nesting the model selection and training in a single for loop
accuracy_list = []
for i in combined_hyperparameter_list:
        model = SVC(C=i[0], gamma=i[1], kernel=i[2])
